...
export class CopyFileAction extends BaseAction {
        ...
        return {
            ...
            properties: {
                fromPath: {
                    ...
                    example: '/Important/doc.pdf'
                },
                toPath: {
                    type: 'string',
                    title: 'Destination Path',
                    description: 'Path for the copy. Use {{variable}} for dynamic data.',
                    example: '/Backup/doc-backup.pdf'
                },
                autorename: {
                    type: 'boolean',
                    title: 'Auto-rename',
    ...
    async execute(config: ActionConfig, context: ActionContext): Promise<ActionResult> {
        try {
            console.log(`[CopyFile] Executing for AREA ${context.areaId}`.cyan);
            ...
            const result = await this.dropboxApi.copyFile(
                fromPath,
                toPath,
            ...
            console.log(`[Dropbox] ✓ File copied: ${fromPath} → ${result.path_display}`.green);
            ...
            console.error(`[CopyFile] ❌ Failed to copy file:`.red, error);
            return {
                success: false,
